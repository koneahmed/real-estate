...
(function ($) {
  ...
  $(window).on("load", function () {
    ...
    // 	$('.banner_content').removeClass('animation');
    // 	$('.banner_content').children().removeClass('animation');
    // 	$('.banner_content').removeAttribute('data-animation');
    // 	$('.banner_content').children().removeAttribute('data-animation');
    // 	$('.banner_content').removeAttribute('data-animation-delay');
    // 	$('.banner_content').children().removeAttribute('data-animation-delay');
    // }
  ...
  $(window).scroll(function () {
    if ($(this).scrollTop() > 150) {
      ...
      $(".demandeDevis").fadeOut();
    }
  });

  /*$(".demandeDevis").on('click', function (e) {
		e.preventDefault();
		$('html, body').animate({
			scrollTop: 0
		}, 600);
  ...
  $.martanianConfigureSlider = function () {
    $(".content_slider").each(function () {
      ...
      var descriptions = slider
        .children(".content_box")
        .children(".content_wrap")
        .children(".descriptions_wrap");
      var activeInsurance = slider
        .children(".content_box")
        .children(".content_wrap")
        .children(".tabs")
        .children("li.active")
      ...
      descriptions
        .children('.description[data-key="' + activeInsurance + '"]')
        .show();
      descriptions.css({
        height: descriptions
          .children('.description[data-key="' + activeInsurance + '"]')
      ...
      slider
        ...
        .children('.image[data-key="' + activeInsurance + '"]')
        .show();
    });
  };
  $(".content_slider .tabs li").click(function () {
    if (!$(this).hasClass("active")) {
      ...
      var oldDescription = slider
        .children(".content_box")
        .children(".content_wrap")
        .children(".descriptions_wrap")
        .children('.description[data-key="' + oldInsuranceKey + '"]');
      var newDescription = slider
        .children(".content_box")
        .children(".content_wrap")
        .children(".descriptions_wrap")
        .children('.description[data-key="' + newInsuranceKey + '"]');
      ...
      slider
        .children(".slider_images")
        .children('.image[data-key="' + oldInsuranceKey + '"]')
        .fadeOut(350);
      slider
        .children(".slider_images")
        .children('.image[data-key="' + newInsuranceKey + '"]')
        .fadeIn(350);
  ...
  jQuery(document).ready(function ($) {
    function prswicher(Checkfilter) {
      $(".switch_box")
        .find(".pt_left,.pt_right")
        .removeClass("pt_switch_active");
      $(".pricing_box")
        .find(".price_tag_left,.price_tag_right")
        .addClass("hide");
