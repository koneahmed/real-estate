<ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
    ...
    <li class=" navigation-header">
        <span data-i18n="Navigation">Organisation</span>
        <i data-feather="more-horizontal"></i>
    </li>

    <li class="nav-item">
        <a class="d-flex align-items-center" href="{{ route('agence.index') }}">
            <i data-feather='airplay'></i>
            <span class="menu-title text-truncate" data-i18n="Email">Agences</span>
        </a>
    </li>
    ...
    <li class=" nav-item">
        <a class="d-flex align-items-center" href="#">
            ...
            <span class="menu-title text-truncate" data-i18n="Produit">Opérations</span>
            {{-- <span class="badge badge-light-warning rounded-pill ms-auto me-1">2</span> --}}
        </a>
        <ul class="menu-content">
            <li>
                <a class="d-flex align-items-center" href="{{ route('operation.index') }}">
                    <i data-feather="circle"></i>
                    <span class="menu-item text-truncate" data-i18n="Analytics">Toutes les opérations</span>
                </a>
            </li>
            {{-- @foreach (\App\Models\Groupe::orderBy('name')->get() as $groupe)
    ...
    <li class=" navigation-header">
        <span data-i18n="Navigation">Configurations</span>
        <i data-feather="more-horizontal"></i>
    </li>
...
@endif
    ...
    <li class=" navigation-header">
        <span data-i18n="Navigation">Paramètrages</span>
        <i data-feather="more-horizontal"></i>
    </li>
    ...
    <li class="nav-item">
        <a class="d-flex align-items-center" href="{{ route('user.index') }}">
            ...
            <span class="menu-title text-truncate" data-i18n="User">Utilisateurs</span>
        </a>
    </li>
@endif
</ul>
