                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="item_box animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                                <div class="item_img">
                                    <a href="#"><img src="{{ $bien->image }}" alt="room_img1"
                                            height="180px"></a>
                                    {{-- <div class="room_services">
                                        ...
                                        <i class="fa fa-tv" data-toggle="popover" data-placement="top" data-trigger="hover"
                                            data-content="TV with cable channels" data-original-title="TV"></i>
                                    </div> --}}
                                ...
                                <div class="item_info">
                                    ...
                                    <div class="item_foot">
                                        <div class="room_price">
                                            <h4 class="text_default">{{$bien->prix}} F CFA</h4>
                            ...
                            <form class="form_style2">
                                <div class="form-group">
                                    <div class="form_control">
                                        <input required="required" placeholder="Araival date"
                                            class="form-control datepicker" name="date" type="text">
                                        <span class="form_icon"><i class="ti-calendar"></i></span>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form_control">
                                        <input required="required" placeholder="Departure date"
                                            class="form-control datepicker" name="date" type="text">
                                        <span class="form_icon"><i class="ti-calendar"></i></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-default btn-block" name="submit">Check
                                        Availability</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="widget widget_facilities">
                            ...
                            <div class="form_style2">
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Airconditioning"
                                        value="">
                                    <label class="form-check-label" for="Airconditioning">Airconditioning</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Balcony"
                                        value="">
                                    <label class="form-check-label" for="Balcony">Balcony/terrace</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Bath"
                                        value="">
                                    <label class="form-check-label" for="Bath">Bath</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Casino"
                                        value="">
                                    <label class="form-check-label" for="Casino">Casino</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Health"
                                        value="">
                                    <label class="form-check-label" for="Health">Health Club</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Non-smoking"
                                        value="">
                                    <label class="form-check-label" for="Non-smoking">Non-smoking</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Parking"
                                        value="">
                                    <label class="form-check-label" for="Parking">Parking</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Restaurant"
                                        value="">
                                    <label class="form-check-label" for="Restaurant">Restaurant</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Service"
                                        value="">
                                    <label class="form-check-label" for="Service">Room Service</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="Wi-Fi"
                                        value="">
                                    <label class="form-check-label" for="Wi-Fi">Wi-Fi</label>
                                </div>
                                <div class="custome-checkbox">
                                    <input class="form-check-input" type="checkbox" name="checkbox" id="TV"
                                        value="">
